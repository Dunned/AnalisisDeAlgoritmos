 ...
 * @author Eduar
 */
public class VentanaM01 extends javax.swing.JFrame {

    Objetos o1=new Objetos("Celular",40,10);
    Objetos o2=new Objetos("Microondas",35,35);
    Objetos o3=new Objetos("Plancha",20,25);
    Objetos o4=new Objetos("Televisor",65,120);
    Objetos o5=new Objetos("Refrigeradora",50,140);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROBLEMA DE LA MOCHILA 0/1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            tituloOrden.setText("OBJETOS ORDENADOS POR BENEFICIO");
            Mochila01 mochilaFraccionaria = new Mochila01();
            ...
            if (pesoTotal<tamanio) {
                JOptionPane.showMessageDialog(this, "NO SE PUEDE LLENAR COMPLETAMENTE LA MOCHILA , PERO SE INTENTO LLENARLA LO MAXIMO POSIBLE");
            }
        } catch (Exception e) {
    ...
    private void botonReiniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonReiniciarActionPerformed
        this.dispose();
        VentanaM01 vetana=new VentanaM01();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaM01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaM01().setVisible(true);
            }
        });
    }
