 ...
 * @author Eduar
 */
public class LinealClaveNombre extends javax.swing.JDialog {
    ...
    public LinealClaveNombre(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public void crearTablaHash(){
        ...
        for (int i = 0; i < codigo.length; i++){
            flag = ReasignacionLineal.insertarReasignacionLinealNombre(miInstituto,codigo[i],nombre[i],pension[i]);
            if (flag==false) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REASIGNACION LINEAL (CLAVE:NOMBRE)");
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        try { 
            int pos = ReasignacionLineal.buscarReasignacionLinealNombre(miInstituto,contenido);
    ...
    private void botonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBorrarActionPerformed
        ...
        try {
            ...
            if (pos != -1 && miInstituto.getNombreDelAlumno(pos).equals(contenido) && !contenido.equals("")){
                ...
                JOptionPane.showMessageDialog(this, "Alumno de nombre: "+contenido+" no existe");
                cajaCodigoBuscar.setText("");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LinealClaveNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LinealClaveNombre dialog = new LinealClaveNombre(new javax.swing.JFrame(), true);
