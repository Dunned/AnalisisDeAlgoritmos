 ...
 * @author Eduar
 */
public class CuadraticaNombre extends javax.swing.JDialog {
    ...
    public CuadraticaNombre(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public void crearTablaHash(){
        ...
        for (int i = 0; i < codigo.length; i++){
            flag = ReasignacionPruebaCuadratica.InsertarPruebaCuadraticaNombre(miInstituto,codigo[i],nombre[i],pension[i]);
            if (flag==false) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REASIGNACION CUADRATICA (CLAVE:NOMBRE)");
        ...
        jPanel1.add(botonSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 490, 120, 50));

        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("TABLA HASH DE 20 POSICIONES CLAVE: CODIGO ALUMNO");
        ...
        jLabel4.setText("BORRAR POR NOMBRE:");
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        try {
            int pos = ReasignacionPruebaCuadratica.BuscarColisionPruebaCuadraticaNombre(miInstituto,contenido);
            if (pos != -1 && miInstituto.getNombreDelAlumno(pos).equals(contenido) && !contenido.equals("")){
                ...
                JOptionPane.showMessageDialog(this, "Alumno con nombre: "+contenido+" no existe");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CuadraticaNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CuadraticaNombre dialog = new CuadraticaNombre(new javax.swing.JFrame(), true);
