 ...
 * @author Eduar
 */
public class Cuadratica extends javax.swing.JDialog {
    ...
    public Cuadratica(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REASIGNACION CUADRATICA (CLAVE:CODIGO)");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cuadratica dialog = new Cuadratica(new javax.swing.JFrame(), true);
