 ...
 * @author Eduar
 */
public class DobleDireccion extends javax.swing.JDialog {
    ...
    public DobleDireccion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public void crearTablaHash(){
        ...
        for (int i = 0; i < codigo.length; i++){
            flag = ReasignacionPorDobleDireccion.InsertarReasignacionDobleDireccion(miInstituto,codigo[i],nombre[i],pension[i]);
            if (flag==false) {
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        try {
            ...
            int pos = ReasignacionPorDobleDireccion.BusquedaReasignacionDobleDireccion(miInstituto,codigo);
            if (pos != -1 && miInstituto.getCodigoDelAlumno(pos)==codigo && codigo!=0){
    ...
    private void botonBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBorrarActionPerformed
        ...
        try {
            int codigo=Integer.parseInt(contenido); 
            int pos = ReasignacionPruebaCuadratica.BuscarColisionPruebaCuadratica(miInstituto,codigo);
            if (pos != -1 && miInstituto.getCodigoDelAlumno(pos)==codigo && codigo!=0){
                JOptionPane.showMessageDialog(this, 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DobleDireccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DobleDireccion dialog = new DobleDireccion(new javax.swing.JFrame(), true);
